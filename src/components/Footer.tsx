...
export default function Footer() {
  ...
  return (
    <footer style={{ background: '#052E16', color: 'rgba(255,255,255,.8)' }} aria-label="Site footer">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">

        {/* Brand */}
        <div className="md:col-span-1 flex flex-col gap-4">
          <div className="flex items-center gap-2.5">
            <div aria-hidden="true" style={{ background: '#EAB308', color: '#111827', width: 36, height: 36, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 16, flexShrink: 0 }}>U</div>
            <div className="leading-none">
              ...
              <div style={{ fontSize: 16, fontWeight: 900, color: '#ffffff', letterSpacing: '.04em' }}>UJIMA</div>
            </div>
          </div>
          <p style={{ fontSize: '0.875rem', lineHeight: 1.7, color: 'rgba(255,255,255,.6)', maxWidth: 220 }}>
            {t('tagline')}
          </p>
        </div>
        ...
        <div>
          ...
          <address style={{ fontStyle: 'normal', display: 'flex', flexDirection: 'column', gap: '.75rem', fontSize: '0.9375rem', color: 'rgba(255,255,255,.65)' }}>
            <div style={{ display: 'flex', gap: '.5rem', alignItems: 'flex-start' }}>
              <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ marginTop: 3, flexShrink: 0, opacity: .6 }}>
            ...
            <a href="mailto:projecto.ujima@gmail.com"
              ...
              onMouseLeave={e => { e.currentTarget.style.color = 'rgba(255,255,255,.65)'; }}
            >
              <svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ flexShrink: 0, opacity: .6 }}>
